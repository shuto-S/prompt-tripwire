...
const en: UiMessages = {
  ...
  showSourceText: "Show sanitized authoritative source",
  originalTask: "Sanitized authoritative task",
  originalDecision: "Sanitized authoritative decision text",
  translationUnavailable:
    "A Japanese reference translation is unavailable. Review the sanitized authoritative source before deciding.",
...
const ja: UiMessages = {
  ...
  showSourceText: "サニタイズ済みの正本原文を表示",
  originalTask: "サニタイズ済みの正本タスク原文",
  originalDecision: "サニタイズ済みの正本判断原文",
  translationUnavailable:
    "日本語の参考訳を生成できませんでした。判断前にサニタイズ済みの正本原文を確認してください。",
