...
- [v0.1.7 release notes](docs/RELEASE_NOTES_v0.1.7.md)
...
v0.1.7 judge distribution. The live Inbox scene comes from an API-key-free
...
`~/.local/lib/prompt-tripwire/0.1.7`; the installer keeps the marketplace source
...
The v0.1.7 installer stages the runtime, switches launchers atomically, and
