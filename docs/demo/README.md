...
> distribution to install; the footage is not presented as a v0.1.7 recording.
>
...
Release line points viewers to the v0.1.7 judge distribution they should
install; it does not represent the footage as a v0.1.7 recording.
