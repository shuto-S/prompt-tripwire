...
| Provide free, unrestricted working-project access through the judging period. | Archive/release route is prepared; no hosted account or paid PromptTripwire service is required. Codex account usage remains under the judge's own OpenAI access. | Route decision and publication pending |
